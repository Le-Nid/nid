...
| Touche | Action |
|---|---|
| <kbd>j</kbd> | Mail suivant |
| <kbd>k</kbd> | Mail précédent |
| <kbd>enter</kbd> / <kbd>o</kbd> | Ouvrir le mail sélectionné |
| <kbd>e</kbd> | Archiver (Gmail) |
| <kbd>"#"</kbd> | Supprimer (corbeille) |
| <kbd>r</kbd> | Marquer comme lu |
| <kbd>u</kbd> | Marquer comme non lu |
| <kbd>"/"</kbd> | Focus sur la barre de recherche |
| <kbd>escape</kbd> | Désélectionner |
